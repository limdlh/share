...
#define POSTURL    "https://iotapi.dev.hongyanyun.cn/controlscreen/smarthome/gateway/user/userId"  //用于测试阶段  //接口已废弃 2022.10.24
//#define POSTURL    "https://iotapi.hongyanyun.cn"  //用于正式阶段
#define POSTFIELDS "{\"gatewayProductKey\":\"a1tNlnarBMz\",\"gatewayDeviceName\":\"H000057509200253\"}"
