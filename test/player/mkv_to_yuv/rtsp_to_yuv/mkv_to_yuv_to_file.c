...
int main() {
    FILE *fp=fopen("Hard_Sun_from_mkv.yuv","w+b");
    if(fp==NULL){
        printf("Cannot open file.\n");
        return -1;
    }

    //char filePath[]       = "./Hard_Sun.mkv";//文件地址
	char filePath[]       = "rtsp://192.168.21.151:554/media/video3";
    ...
    do{
        ...
        //==================================== 打开文件 ======================================//
        if ((ret=avformat_open_input(&fmtCtx, filePath, NULL, &options)) != 0) {
